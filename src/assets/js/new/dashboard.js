(function($) {
  ...
  $(function() {
    ...
    // Carousel nxt prv btns disable on first & last slides
    ...
    if ($("#serviceSaleProgress").length) {
      ...
      let linearGradient = '<defs><linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="userSpaceOnUse"><stop offset="20%" stop-color="#04538b"/><stop offset="50%" stop-color="#002b49"/></linearGradient></defs>';
